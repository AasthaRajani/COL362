...
public class MyCalciteConnection {
    ...
    public RelNode logicalToPhysical(RelNode node, RelTraitSet requiredTraitSet) {
        ...
        System.out.println("In logical to physical 1");
        RelNode optimizedPlan = planner.findBestExp();
        System.out.println("In logical to physical 2 " + optimizedPlan.toString());
//        PRel p = (PRel) optimizedPlan;
        System.out.println("In logical to physical 3");
